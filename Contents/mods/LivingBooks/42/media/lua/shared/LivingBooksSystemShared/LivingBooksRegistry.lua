...
function BookRegistry.scan()
    ...
    local item1 = ScriptManager.instance:getItem("LivingBooks.Frankenstein")
    local item2 = ScriptManager.instance:getItem("LivingBooks.DonQuijoteDeLaMancha")

    print("Frankenstein Item:", tostring(item1))
    print("DonQuijote Item :", tostring(item2))
